...
#define RESP_RX_TO_FINAL_TX_DLY_UUS 2120
/* Receive response timeout. See NOTE 5 below. */
#define RESP_RX_TIMEOUT_UUS 1510
...
int aoa_rtls_initiator_txt(void)
{   
    ...
    while (1)
    {
        ...
        {   
            printf("poll trans ok | resp fail \n ");
